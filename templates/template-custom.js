(()=>{
 ...
 let data={};try{data=JSON.parse(localStorage.getItem('zapifyTemplatePreview')||'{}')}catch(e){}apply(data);window.addEventListener('message',e=>{if(e.data?.type==='zapify-preview')apply(e.data.config||{})});window.ZAPIFY_TEMPLATE_PRESETS=presets[type]||[];
})();
